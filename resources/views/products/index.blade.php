        ...
        <div class="container mx-auto">
            ...
            <div class="input-group relative flex items-stretch py-5">
                ...
                <div class="text-white">
                    ...
                    <p class="hover:text-green-300 cursor-pointer hover:scale-110 text-center"> Recien Agregados </p>
                    <p class="hover:text-green-300 cursor-pointer hover:scale-110 text-center"> Mejores precios </p>
                    <p class="hover:text-green-300 cursor-pointer hover:scale-110 text-center"> Ultimos disponibles </p>
