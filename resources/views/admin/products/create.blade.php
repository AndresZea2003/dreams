                    ...
                    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="flex flex-wrap -mx-3 my-6">
                            ...
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <input
                                    class="appearance-none block w-full bg-white text-black border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                                    name="price" id="price" type="number" placeholder="$100" value="{{ old('price') }}">
                                @error('price')
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full px-3">
                                ...
                                <input
                                    ...
                                    placeholder="Product description example" value="{{ old('description') }}">
                                @error('description')
                        ...
                        <div class="flex flex-wrap -mx-3 mb-2">
                            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                ...
                                <input type="number" name="available"
                                       ...
                                       placeholder="15" value="{{ old('available') }}">
                                @error('available')
