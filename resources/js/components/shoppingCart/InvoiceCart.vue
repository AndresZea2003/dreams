    ...
    <div class="h-screen bg-zinc-400">
        <div class="grid grid-cols-2 h-full">
            <div class="flex justify-end items-center">
                <div class="bg-gray-200 px-10 py-5 rounded-md shadow-2xl">
                        ...
                        <table class="my-5">
                            <tbody class="border-y-2 border-black">
                                <tr v-for="item in items" class="border-b border-gray-400">
                                    ...
                                    <td class="p-4 text-xl font-alatsi">{{ item.name }}</td>
                                    <td class="p-4">Cantidad: <span class="font-bold">{{ item.quantity }}</span></td>
                                    <td class="p-4 font-bold">${{ item.price }} COP</td>
                                </tr>
                            </tbody>
                        </table>
                        <div class="grid grid-cols-2">
                            <p class="font-bold col-span-2">Mas informacion</p>
            ...
            <div class="flex justify-center h-full">
                <div class="bg-gray-200 h-full">
                    <div class="text-center flex flex-col justify-center h-full">
                        <div class="flex flex-col mx-10 items-center pb-10">
                            <span class="font-fugaz-one text-gray-400 mb-10 text-6xl">Dreams</span>
                            <img
                                class="h-16 w-16 rounded-full"
                                :src="`https://ui-avatars.com/api/?name=${user.name}&background=eed09d&color=000&size=50&bold=true`"
                                alt="Avatar"
                            />
                            <p class="font-bold py-2">{{ user.name }}</p>
                            <p class="font-bold">{{ user.email}}</p>
                        </div>

                        <p class="text-left px-10 font-bold text-xl">Resumen de compra</p>
                        <div class="text-center border-t-2 border-gray-400 py-5 mx-10">
                        ...
                        <div class="text-center border-t-2 border-gray-400 pt-5 mx-10">
                            <p class="flex justify-between">
                        ...
                        <div class="flex flex-col justify-center mt-5">
                            ...
                            <div>
                                <a href="http://dreams.test/shop">
                                    <button class="mt-2 focus:shadow-outline rounded bg-zinc-800 py-1 px-4 font-bold text-white hover:bg-opacity-90 focus:outline-none">
