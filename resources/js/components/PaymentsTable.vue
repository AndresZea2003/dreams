    ...
    <div class="mt-5 flex justify-center">
        <div>
            <div class="flex flex-col items-center">
                <span class="font-alatsi text-3xl">Historial de compras</span>
            </div>
            <table class="overflow-hidden rounded-lg border border-gray-600 shadow">
                ...
                <tbody class="bg-gray-400">
                    <tr v-for="payment in payments" :key="payment.id">
                        ...
                        <td class="py-3 pl-6 text-left text-xs text-3xl font-medium uppercase tracking-wider">
                            {{ payment.status }}
                        </td>
            ...
            <div class="flex justify-start">
                ...
                >
                    <a href="http://dreams.test/products"> Regresar </a>
                </button>
            </div>
        </div>
    </div>
